...
const Homepage = ({ getHomeVideos, home }) => {
    ...
    <>
      ...
      >
        ...
        >
          {home &&
            home.upcoming &&
            home.upcoming.map((stream, index) => {
              if (index < 3) {
                let thumbnail = null;
                if (stream.thumb1) {
          ...
          <Container fluid>
            <Row>
              <Col sm="12" className="overflow-hidden">
                ...
                {home && home.live && home.live.length > 0 ? (
          ...
          <Container fluid>
            <Row>
              <Col sm="12" className="overflow-hidden">
                ...
                {home && home.archive && home.archive.length > 0 ? (
...
const mapStateToProps = (state) => ({
  home: state.videos.home,
});

const mapDispatchToProps = (dispatch) => {
  return {
    getHomeVideos: () => {
      dispatch(videoActions.getHomeVideos());
    },
  };
};
